...
# amir = Player("Amir")
# amir.draw(deck).draw(deck).draw(deck) # change ///////////////////////////////
# amir.showhand()
...
class Card(object):
    def __init__(self, suits, value):
        ...
        self.value = value
    def show_card(self): 
        print('i am show_card() method of class Card')# chnage ///////////////////////////////
        print( '{} of {}'.format(self.value, self.suits))
...
class Player(object):
    ...
    def draw(self, deck):
        print('Enter into draw() method') # chnage ///////////////////////////////
        self.hand.append(deck.draw_card())
        self.showhand() # chnage ///////////////////////////////
        print('........................................return self object while out of draw() method ')# chnage ///////////////////////////////
...
amir = Player("Amir")
amir.draw(deck).draw(deck).draw(deck) #to understand this see change
amir.showhand()
...
# 1st
# amir.draw(deck) : draw -> append_hand -> return self object
# 2nd 
# self_object.draw(deck) => draw -> append_self_hand -> return self_edited_object
# 3rd
# self_edited_object.draw(deck) => draw -> append_self_hand -> return self_edited_object

# #ii
# amir.showhand()
# show card in hand after drawing card for 3 time 
