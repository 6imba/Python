# # 1:
# csv_file1 = open('C:/PythonDjango/Python/Data_Storing_File_Formate/3.CSV/Code/Test/2.CSV_file_with_CSV_data.csv')
...
# # 2:
# csv_file2 = open('./2.CSV_file_with_CSV_data.csv')
