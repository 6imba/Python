...
# dump_dict = json.dumps(res, indent=2)
# print(type(dump_dict))
# # print(dump_dict.keys()) #error as string has no any key
...
# #   a.> Print the entire object. If it’s small enough, you may be able to make sense of the printout directly. If it’s a little bit larger, you may find it helpful to “pretty-print” it, with indentation showing the level of nesting of the data. We don’t have a way to pretty-print in our online browser-based environment, but if you’re running code with a full Python interpreter, you can use the dumps function in the json module. For example:
...
# # 1.b.>If printing the entire object gives you something that’s too unwieldy, you have other options for making sense of it.
...
#    print(json.dumps(res3, indent=2)[:300])
...
# #5. Extract. Let’s print out the user’s screen name and when their account was created.
...
# #print(type(res2)) # it's a list!
# #print(len(res2))  # looks like one item representing each of the three tweets
# for res3 in res2: # ------------>>>>>>> for all item of list<<<<<<<<<<<<<<---------------------
#    #print("----Level 3: a tweet----")
#    #print(json.dumps(res3, indent=2)[:30])
#    res4 = res3['user']
#    #print("----Level 4: the user who wrote the tweet----")
