...
# lambda species,population : species if population<2500 ,pop_info)
# [species for species,population in pop_info if population<2500]

# list1 = [1,2,3,4,5]
# odd = filter( lambda numb : numb if numb%2==0, list1)
# print(odd)

# list1 = [1,2,3,4,5]
# odd = filter( lambda numb :  numb%2==0, list1)
# print(list(odd))